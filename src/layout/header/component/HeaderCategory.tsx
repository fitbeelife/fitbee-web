        ...
        <ul>
          <li>
            ...
            <ul className="cat-submenu">
              <li>
                <Link href="/course-grid">Physcial Fitness</Link>
              </li>
              <li>
                <Link href="/course-grid">Mental Fitness</Link>
              </li>
              <li>
                <Link href="/course-grid">Educational Fitness</Link>
              </li>
              <li>
                <Link href="/course-grid">Life Coaching</Link>
              </li>
            </ul>
          </li>
        </ul>
