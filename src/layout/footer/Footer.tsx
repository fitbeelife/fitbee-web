                ...
                <div className="col-xxl-3 col-xl-3 col-lg-3 col-md-4 col-sm-6">
                  <div className="footer__widget mb-50">
                    ...
                    <div className="footer__widget-body">
                      <p>
                        Great lesson ideas and lesson plans for fitness teachers!
                    ...
                    <div className="footer__widget-body">
                      <div className="footer__link">
                        <ul>
                          ...
                          <li>
                            <Link href="/course-grid">Training Sessions</Link>
                          </li>
                          <li>
                            <Link href="/event-details">Events</Link>
                          </li>
                          <li>
                            <Link href="/instructor">Guides</Link>
                          </li>
                          <li>
                            <Link href="/instructor">Career</Link>
                          </li>
                          <li>
                            <Link href="/instructor">Become a Trainer</Link>
                          </li>
                          <li>
